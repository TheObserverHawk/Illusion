...
4. Chaque entrée de la table des pages contient : 1 bit de validité + 14 bits de PPN. Pour simplifier, on considère 2 octets par entrée.
5. Il y a $2^{20}$ entrées (= nombre de pages virtuelles)
6. La taille totale de la table des pages est de 2 octets * 220 = 2 MB, ce qui occupe 2 MB / 4 KB = 512 pages 
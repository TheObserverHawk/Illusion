...
En représentation normalisée, le bit le plus significatif est toujours égal à 1. Il est donc inutile de le représenter : $$m=\underbrace{1\ m_{M-2}\cdots m_0}_{M\text{ bits significatifs (maximum)}}$$ On peut donc 
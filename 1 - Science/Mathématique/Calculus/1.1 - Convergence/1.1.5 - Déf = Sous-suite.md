...
2. On a $(z_n)_{n\ge 1}$ est une sous-suite de $(x_n)_{n\ge 1}$ :
	1. En effet, posons $$\varphi:\mathbb{N}^{\ge 1}\to\mathbb{N}^{\ge 1}:n\mapsto 2n+1$$ On a que $\varphi$ est strictement croissante car $$n_1<n_2\Rightarrow 2n_1+1<2n_2+1$$ i.e. $$\varphi(n_1)<\$$
## Définition 2 
Soient $(X_n)_{n \in \mathbb{I}}$ et $(Y_n)_{n \in \mathbb{J}}$ 2 suites 

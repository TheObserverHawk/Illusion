...
Montrons que $$[a-r;a+r]\subseteq\ ]0;3]$$ Soit $x\in\ [a-r;a+r]$, on a $x\ge a-r$. On a $$r<\frac{|a|}{2}\quad\Rightarrow\quad-r>\frac{-|a|}{2}$$ Donc $$\begin{aligned}1)\quad\text{ }\quad x\ge a-r>a-\frac{|a|}{2}&=a-\frac{a}{2}\\&=\frac{a}{2}>0\\&\Rightarrow x>0\\2)\quad\text{ }\quad x\le a+r\underbrace\le_{\color{red}\text{par déf. de }r}a+\frac{\color{green}|a-3|}{2}&=a+\frac{\color{green}(-a+3)}{2}\quad\text{ , }{\color{green}|a-3|=-a+3\text{ car }a-3<0}\\&=\end{aligned}$$

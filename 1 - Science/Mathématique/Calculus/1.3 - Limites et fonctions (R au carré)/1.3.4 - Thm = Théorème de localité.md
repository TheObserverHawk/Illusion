...
Montrons que $$[a-r;a+r]\subseteq\ ]0;3]$$ Soit $x\in\ [a-r;a+r]$, on a $x\ge a-r$. On a $$r<\frac{|a|}{2}\quad\Rightarrow\quad-r>\frac{-|a|}{2}$$ Donc $$\begin{aligned}1)\quad\text{ }\quad x\ge a-r\overbrace>^{\color{red}\text{par déf. de }r}a-\frac{\color{green}|a|}{2}&=a-\frac{\color{green}a}{2}\quad\text{ , }{\color{green}|a-.}\\&=\frac{a}{2}>0\\&\Rightarrow x>0\\2)\quad\text{ }\quad x\le a+r\underbrace\le_{\color{red}\text{par déf. de }r}a+\frac{\color{green}|a-3|}{2}&=a+\frac{\color{green}(-a+3)}{2}\quad\text{ , }{\color{green}|a-3|=-a+3\text{ car }a-3<0}\\&=\frac{a+3}{2}<\frac{3+3}{2}=3\\&\Rightarrow x<3\quad\Rightarrow\quad x\le 3\end{aligned}$$ Donc $$x\in\ ]0;3]$$ Par la propriété de localité, on a $$\underset{x\to a}{\lim}f(x)=\underset{\overset{x\to a}{x\in\ [a-r;a+r]}}{\lim}f(x)\overbrace{=}^{\color{red}x\in\ [a-r;a+r]\quad\Rightarrow\quad x\in\ ]0;3]}\underset{\overset{x\to a}{x\in\ [a-r;a+r]}}{\lim}x^2+1\overbrace{=}^{\color{red}\text{par rés. du cours + RDC}}a^2+1$$
